...
class StoreVM: ObservableObject {
    ...
    private let productsIDs: [String] = ["com.dladev.WordsSearch.yearly", "com.dladev.WordsSearch.monthly"]
    ...
    func restorePurchases() async {
        ...
        func updateCustomerProductStatus() async {
            ...
            // Update premiumUser based on purchased subscriptions
                    premiumUser = !purchasedSubscriptions.isEmpty
        }
